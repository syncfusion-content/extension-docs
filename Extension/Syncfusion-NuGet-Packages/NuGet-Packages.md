...
N> If you need to Install earlier version of 16.2.0.46 Syncfusion<sup style="font-size:70%">&reg;</sup> NuGet packages, [configure Syncfusion private feed URL](https://help.syncfusion.com/extension/syncfusion-nuget-packages/nuget-packages#syncfusion-nuget-feed-url-configuration).
