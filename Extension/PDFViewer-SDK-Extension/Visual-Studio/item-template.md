...
2.	The Syncfusion<sup style="font-size:70%">&reg;</sup> PDF Viewer SDK Item Template wizard will be launched, displaying component for the selected platform (WinForms or WPF).
    ...
    - Windows Forms:
        ...
        ![Syncfusion WinForms PDF Viewer SDK Item template Component](images/Add-Syncfusion-ui.png)

    - WPF:
        
        ![Syncfusion WPF PDF Viewer SDK Item template Component](images/Add-Syncfusion-ui1.png)
