...
3. Choose **Syncfusion Blazor WebAssembly App** and press **Enter**. When prompted, pick the folder where you want the new project created.
...
6. In template options, you can customize the project type, progressive web application support, and https configuration based on the version of the .NET SDK you are using.
    ...
    ![WASMTemplate](images/wasmType.png)
