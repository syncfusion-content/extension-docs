...
description: Syncfusion Troubleshooter is a Visual Studio extension that resolves Syncfusion assembly and web.config configuration issues in your projects.
platform: extension
