...
The Syncfusion® Sample Creator is a tool that allows you to create Syncfusion® ASP.NET Core (Essential® JS 2) projects with sample code for required Syncfusion® component features and Syncfusion® control configuration.

> The Syncfusion® ASP.NET Core Sample Creator utility is available from v16.3.0.17.

The following steps are used to create the Syncfusion® ASP.NET Core (Essential® JS 2) Application by using the Sample Creator utility:

1. Follow one of the options below to launch the ASP.NET Core (Essential® JS 2) Sample Creator application:

    **Option 1:**

    Click **Syncfusion® Menu** and choose **Essential Studio® for ASP.NET Core > Launch Sample Creator…** in **Visual Studio.**
...
2. Syncfusion® controls and features are listed in the ASP.NET Core Sample Creator based on the category wise such as UI Component Suite, Grid SDK, Scheduler SDK, Gantt SDK, Rich Text Editor SDK, Diagram SDK,Chart SDK, File Manager SDK.
