...
The Syncfusion® ASP.NET Core Visual Studio Extensions can be accessed through the Syncfusion® Menu to create and configure the project with Syncfusion® references in Visual Studio.

> Syncfusion® Extension is published in Visual Studio Marketplace. You can download ASP.NET Core Extensions [here](https://marketplace.visualstudio.com/items?itemName=SyncfusionInc.ASPNETCoreExtensions)

## IMPORTANT

> The Syncfusion® ASP.NET Core (Essential® JS 2) menu option is available from v17.1.0.32.

Syncfusion® provides the following features in Visual Studio:
