...
5. The controller and view files are generated successfully, and the required Syncfusion® NuGet packages and styles which are required to render the Syncfusion® control are also added.
