...
description: Learn here about how to create a Syncfusion® .NET MAUI application using the Syncfusion® .NET MAUI Extension for Visual Studio Code.
platform: extension
component: Common
documentation: ug
---
...
N> Syncfusion<sup>®</sup> Visual Studio Code project templates support .NET MAUI project templates starting from `v25.1.35`.

The following steps will assist you in creating your **Syncfusion<sup>®</sup> .NET MAUI Application** through **Visual Studio Code**:
...
3. To select a component, click the **Next** button or the **Components** tab. From there, you can add the desired Syncfusion<sup>®</sup> .NET MAUI components to your application. Simply choose the necessary Syncfusion<sup>®</sup> .NET MAUI components for your project which are listed based on category wise such as UI Component Suite, Grid SDK, Chart SDK, Scheduler SDK, Gantt SDK and Rich Text Editor SDK.
    ...
    **Option 2:** Click the **'x'** button for the corresponding component in the component list under **Components Selected**.
