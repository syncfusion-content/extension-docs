...
description: Learn here all about introduction on Syncfusion® .NET MAUI extension for Visual Studio Code which made integration ease.
platform: extension
component: Common
documentation: ug
---
...
* **Essential<sup>®</sup> UI Kit:** Adds pre-built XAML templates to your .NET MAUI application to quickly scaffold user interfaces.
