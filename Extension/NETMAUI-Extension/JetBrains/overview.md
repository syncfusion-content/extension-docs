---
layout: post
title: Essential® UI Kit for .NET MAUI Plugin - JetBrains Rider | Extension | Syncfusion
...
* [Download and Installation](download-and-installation.md) – Install the plugin from the JetBrains Marketplace or from disk.
* [Essential® UI Kit for .NET MAUI](Essential-UI-Kit.md) – Add ready-to-use XAML templates to your .NET MAUI project.