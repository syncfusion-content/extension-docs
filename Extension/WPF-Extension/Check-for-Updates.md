...
description: Syncfusion Check for Updates provides extensions to update to the latest version of the Essential Studio release.
platform: extension
...
Syncfusion<sup style="font-size:70%">&reg;</sup> provides extensions to update to the most recent version of the Essential Studio<sup style="font-size:70%">&reg;</sup> release. Installing the most recent version ensures that you always have the most up-to-date features, fixes, and improvements.

I> The Syncfusion<sup style="font-size:70%">&reg;</sup> Check for Updates feature is available from v17.1.0.32.
