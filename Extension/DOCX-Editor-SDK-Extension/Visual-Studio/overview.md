...
The Syncfusion® DOCX Editor SDK extensions provides the following add-ins in Visual Studio:

[Template-Studio](template-studio):  Creates Syncfusion® applications based on platform (Blazor and WPF) with required configuration for development with Syncfusion® DOCX Editor SDK components.

[Code Generator](code-generator): Adds Syncfusion®DOCX Editor SDK component code in razor file of Blazor Application at required place.

[Item Template](item-template): Adds predefined Syncfusion®DOCX Editor SDK controls and the required assemblies in WPF Application.

[Creator Sample](sample-creator): Creates Syncfusion® ASP.NET Core or MVC application with the sample code of required Syncfusion® DOCX Editor controls and features.
