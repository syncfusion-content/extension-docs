...
description: Syncfusion DOCX Editor SDK Item Templates provides to add the predefined forms with Syncfusion component in WPF application.
platform: extension
control: Syncfusion Extensions
documentation: ug
---

# Add Syncfusion® DOCX Editor SDK component to WPF Application
