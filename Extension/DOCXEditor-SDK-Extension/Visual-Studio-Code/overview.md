---
layout: post
title: Syncfusion® DOCX Editor SDK Extension for Visual Studio Code
description: Learn here all about introduction on Syncfusion® DOCX Editor SDK extension for Visual Studio Code which made integration ease.
platform: extension
...
[Project-Template](create-project): Creates Syncfusion® DOCX Editor SDK applications with required configuration for development with Syncfusion® DOCX Editor SDK component.

[Code Snippet](code-snippet): Adds Syncfusion® DOCX Editor SDK component code in razor file of Blazor Application at required place.