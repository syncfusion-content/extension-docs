...
description: Learn here all about how to use the code snippet utility of Syncfusion DOCX Editor SDK Extension for Visual Studio Code and much more.
platform: extension
...
## Add a Syncfusion® DOCX Editor SDK component in a Blazor application

The instructions below guide you through the process of using the Syncfusion® DOCX Editor SDK code snippet in your Blazor application.

1. In Visual Studio Code, open an existing Blazor Application or create a new Blazor Application.

2. Open the razor file that you need and place the cursor in the required place where you want to add a Syncfusion® DOCX Editor SDK component.

3. You can find the Syncfusion® DOCX Editor SDK component by typing **sf** in the format shown below.

    ```
    sf<Syncfusion component name>-<Syncfusion component feature>
    For Example, sfword
    ```
4. Choose the Syncfusion® component and press the **Enter** or **Tab** key; the Syncfusion® DOCX Editor SDK component will be added to the razor file.
...
3. Add the Syncfusion® Blazor [theme](https://blazor.syncfusion.com/documentation/appearance/themes) in the `<head>` element of the **~/Components/App.razor** page for a Web App, in the `<head>` element of the **~/Pages/_Host.html** page for a server application, and in the **~/wwwroot/index.html** page for a client application.

    ![Themes](images/CDNLink.png)

4. Open the **~/Program.cs** file for a Web App, a server application, and a client application, and then register the Syncfusion® Blazor Service.
